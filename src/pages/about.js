  ...
  <Layout>
    ...
    <div>
            ...
            <li>
							...
							<ul>
								<li>Currently a sole proprietor and solopreneur, wearing every single hat while directing the design and manufacturing of moisture wicking athleisure wear</li>
								<li>Principal Web Developer, managing a Shopify backend and building a custom React/GatsbyJS frontend</li>
								<li>Lead Digital Marketing Manager, running a digial marketing campaign on instagram and TikTok</li>
								<li>Personally pack and ship all orders, in some cases personally manufacturing the product</li>
							</ul>
						</li>
						<li>
